...
class I18n_Conductor
{
  ...
  public function home_url($url, $path)
  {
    ...
    $locale = get_locale();
    if ($locale === I18N_CONDUCTOR_DEFAULT_LANG) return rtrim($url, '/') . '/';
  ...
  public function notfound_redirect()
  {
    ...
    if (is_404() && $is_single && defined('I18N_CONDUCTOR_NOTFOUND_REDIRECT_SLUG'))
    {
      wp_safe_redirect(home_url(I18N_CONDUCTOR_NOTFOUND_REDIRECT_SLUG));
      exit;
    }
  }
