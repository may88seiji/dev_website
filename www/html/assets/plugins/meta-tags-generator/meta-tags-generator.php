 ...
 * Version: 1.0
 * Description: render meta tags on wp header.
 * Author: CINRA Inc,.
...
if (!defined( 'META_TAGS_GENERATOR_AUTO_RENDER' )) define( 'META_TAGS_GENERATOR_AUTO_RENDER', true );
...
class MetaTagsGenerator
{
  ...
  {
    do_action( 'meta_tags_generator_init' );
  }
  ...
  public static function generate()
  {
    ...
    return apply_filters( 'meta_tags_generator', $html);
  }
...
add_action( 'wp', array( 'MetaTagsGenerator', 'init' ) );
if ( META_TAGS_GENERATOR_AUTO_RENDER ) add_action( 'wp_head', array('MetaTagsGenerator', 'render') );
...
{
  MetaTagsGenerator::set( $key, $content, $key_attr, $content_attr, $tagname, $ignore_sanitize );
}
...
{
  $content = MetaTagsGenerator::sanitize($raw_content, 240);
