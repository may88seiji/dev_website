...
//$status = ( isset($this->action_status) && 'none' != $this->action_status ) ? $this->action_status : apply_filters( 'usces_member_list_action_status', $status );
//$message = ( isset($this->action_message) ) ? $this->action_message : apply_filters( 'usces_member_list_action_message', $message );
